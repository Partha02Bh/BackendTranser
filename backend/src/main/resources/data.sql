...
INSERT INTO accounts (id, username, holder_name, balance, status, version) VALUES 
...
ON DUPLICATE KEY UPDATE holder_name = VALUES(holder_name), username = VALUES(username);
